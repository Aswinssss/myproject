              ...
              <h3 class="login-heading mb-4">Register here!</h3>
               <form action="{{url('post-registration')}}" method="POST" id="regForm">
                ...
                <div class="form-label-group">
                  <input type="text" id="inputfName" name="f_name" class="form-control" placeholder="First name" autofocus>
                  ...
                  <div class="form-label-group">
                  <input type="text" id="inputlName" name="l_name" class="form-control" placeholder="Last name" autofocus>
                ...
                <div class="form-label-group">
                  <input type="text" name="phone" id="inputphone" class="form-control" placeholder="Phone-No" >
